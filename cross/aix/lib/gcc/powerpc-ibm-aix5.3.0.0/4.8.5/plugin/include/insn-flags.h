...
static inline rtx gen_load_toc_v4_PIC_1_normal    (rtx);
static inline rtx
gen_load_toc_v4_PIC_1_normal(rtx ARG_UNUSED (a))
{
  return 0;
}
...
static inline rtx gen_load_toc_v4_PIC_1b_normal   (rtx, rtx);
static inline rtx
gen_load_toc_v4_PIC_1b_normal(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_load_macho_picbase          (rtx);
static inline rtx
gen_load_macho_picbase(rtx ARG_UNUSED (a))
{
  return 0;
}
static inline rtx gen_macho_correct_pic           (rtx, rtx, rtx, rtx);
static inline rtx
gen_macho_correct_pic(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_load_toc_v4_PIC_1           (rtx);
static inline rtx
gen_load_toc_v4_PIC_1(rtx ARG_UNUSED (a))
{
  return 0;
}
