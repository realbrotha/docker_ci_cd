...
#endif
#ifdef GENERATOR_FILE
extern int internal_nothing_1;
#else
  int x_internal_nothing_1;
#define internal_nothing_1 global_options.x_internal_nothing_1
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_target_option
{
  ...
  signed char x_internal_nothing_1;
...
#define OPTION_MASK_CMPB (HOST_WIDE_INT_1 << 2)
#define OPTION_MASK_CRYPTO (HOST_WIDE_INT_1 << 3)
#define OPTION_MASK_DIRECT_MOVE (HOST_WIDE_INT_1 << 4)
...
#define OPTION_MASK_HTM (HOST_WIDE_INT_1 << 9)
...
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1 << 22)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1 << 25)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1 << 27)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1 << 28)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_UPPER_REGS_DF (HOST_WIDE_INT_1 << 30)
#define OPTION_MASK_UPPER_REGS_SF (HOST_WIDE_INT_1 << 31)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_VSX_TIMODE (HOST_WIDE_INT_1 << 33)
...
enum opt_code
{
  ...
  OPT_mabi_altivec = 1039,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1040,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1041,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1042,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1043,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1044,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1045,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1046,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1047,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1048,                       /* -mabi=spe */
  OPT_maix_struct_return = 1049,             /* -maix-struct-return */
  OPT_maix32 = 1050,                         /* -maix32 */
  OPT_maix64 = 1051,                         /* -maix64 */
  OPT_malign_ = 1052,                        /* -malign- */
  OPT_malign_branch_targets = 1053,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1054,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1055,             /* -mallow-movmisalign */
  OPT_maltivec = 1056,                       /* -maltivec */
  OPT_maltivec_be = 1057,                    /* -maltivec=be */
  OPT_maltivec_le = 1058,                    /* -maltivec=le */
  OPT_malways_hint = 1059,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1060,       /* -mavoid-indexed-addresses */
  OPT_mblock_move_inline_limit_ = 1061,      /* -mblock-move-inline-limit= */
  OPT_mcmodel_ = 1062,                       /* -mcmodel= */
  OPT_mcmpb = 1063,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1064,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1065,                          /* -mcpu= */
  OPT_mcrypto = 1066,                        /* -mcrypto */
  OPT_mdebug_ = 1067,                        /* -mdebug= */
  OPT_mdirect_move = 1068,                   /* -mdirect-move */
  OPT_mdlmzb = 1069,                         /* -mdlmzb */
  OPT_mdouble_float = 1070,                  /* -mdouble-float */
  OPT_mefficient_unaligned_vector = 1071,    /* -mefficient-unaligned-vector */
  OPT_mfloat_gprs_ = 1072,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1073,                     /* -mfp-in-toc */
  OPT_mfprnd = 1074,                         /* -mfprnd */
  OPT_mfpu_ = 1075,                          /* -mfpu= */
  OPT_mfriz = 1076,                          /* -mfriz */
  OPT_mfull_toc = 1077,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1078, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1079,            /* -mgen-cell-microcode */
  OPT_mhard_dfp = 1080,                      /* -mhard-dfp */
  OPT_mhard_float = 1081,                    /* -mhard-float */
  OPT_mhtm = 1082,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1083,            /* -minsert-sched-nops= */
  OPT_misel = 1084,                          /* -misel */
  /* OPT_misel_no = 1085, */                 /* -misel=no */
  /* OPT_misel_yes = 1086, */                /* -misel=yes */
  OPT_mlong_double_ = 1087,                  /* -mlong-double- */
  OPT_mlongcall = 1088,                      /* -mlongcall */
  OPT_mlra = 1089,                           /* -mlra */
  OPT_mmfcrf = 1090,                         /* -mmfcrf */
  OPT_mmfpgpr = 1091,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1092,                   /* -mminimal-toc */
  OPT_mmulhw = 1093,                         /* -mmulhw */
  OPT_mmultiple = 1094,                      /* -mmultiple */
  OPT_mno_fp_in_toc = 1095,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1096,                 /* -mno-sum-in-toc */
  OPT_mno_update = 1097,                     /* -mno-update */
  OPT_moptimize_swaps = 1098,                /* -moptimize-swaps */
  OPT_mpaired = 1099,                        /* -mpaired */
  OPT_mpe = 1100,                            /* -mpe */
  OPT_mpointers_to_nested_functions = 1101,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1102,                       /* -mpopcntb */
  OPT_mpopcntd = 1103,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1104,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1105,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1106,                 /* -mpower8-vector */
  /* OPT_mpowerpc = 1107, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1108,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1109,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1110,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1111,  /* -mprioritize-restricted-insns= */
  OPT_mquad_memory = 1112,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1113,            /* -mquad-memory-atomic */
  OPT_mrecip = 1114,                         /* -mrecip */
  OPT_mrecip_precision = 1115,               /* -mrecip-precision */
  OPT_mrecip_ = 1116,                        /* -mrecip= */
  OPT_msave_toc_indirect = 1117,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1118,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1119,                  /* -msched-epilog */
  OPT_msched_groups = 1120,                  /* -msched-groups */
  OPT_msched_prolog = 1121,                  /* -msched-prolog */
  OPT_msimple_fpu = 1122,                    /* -msimple-fpu */
  OPT_msingle_float = 1123,                  /* -msingle-float */
  OPT_msingle_pic_base = 1124,               /* -msingle-pic-base */
  OPT_msoft_float = 1125,                    /* -msoft-float */
  OPT_mspe = 1126,                           /* -mspe */
  /* OPT_mspe_no = 1127, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1128, */                 /* -mspe=yes */
  OPT_mstring = 1129,                        /* -mstring */
  OPT_msum_in_toc = 1130,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1131,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1132,                   /* -mtls-markers */
  OPT_mtraceback_ = 1133,                    /* -mtraceback= */
  OPT_mtune_ = 1134,                         /* -mtune= */
  OPT_mupdate = 1135,                        /* -mupdate */
  OPT_mupper_regs_df = 1136,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1137,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1138,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1139,            /* -mvectorize-builtins */
  OPT_mvrsave = 1140,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1141, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1142, */              /* -mvrsave=yes */
  OPT_mvsx = 1143,                           /* -mvsx */
  OPT_mvsx_align_128 = 1144,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1145,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1146,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1147, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1148,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1149,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1150,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1151,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1152,                     /* -mxl-compat */
  OPT_n = 1153,                              /* -n */
