/*  DO NOT EDIT THIS FILE.
	...
	"/opt/cross/aix/sysroot/usr/include/stdio.h"
...
#include <stdarg.h>
#ifndef FIXINC_WRAP_STDIO_H_AAB_AIX_STDIO
...
extern int  vsscanf();
#else
extern int  vscanf(const char *__restrict__, __gnuc_va_list);
extern int  vfscanf(FILE *__restrict__, const char *__restrict__, __gnuc_va_list);
extern int  vsscanf(const char *__restrict__, const char *__restrict__, __gnuc_va_list);
#endif
#endif
...
extern int	vfprintf(FILE *__restrict__, const char *__restrict__, __gnuc_va_list);
extern int	vprintf(const char *__restrict__, __gnuc_va_list); 
extern int	vsprintf(char *__restrict__, const char *__restrict__, __gnuc_va_list);
#if (_XOPEN_SOURCE >= 500) || defined(_ISOC99_SOURCE)
extern int	vsnprintf(char *__restrict__, size_t, const char *__restrict__, __gnuc_va_list);
#endif /* _XOPEN_SOURCE >= 500 || defined(_ISOC99_SOURCE) */
#else
#define _HIDDEN_DUMMY_VA_LIST         /* define a type not in the namespace */
#include <va_list.h>
extern int	vfprintf(FILE *__restrict__, const char *__restrict__, __gnuc_va_list);
extern int	vprintf(const char *__restrict__, __gnuc_va_list); 
extern int	vsprintf(char *__restrict__, const char *__restrict__, __gnuc_va_list);
...
#include <va_list.h>	/* __gnuc_va_list must be define in XPG4 */
...
#endif  /* FIXINC_WRAP_STDIO_H_AAB_AIX_STDIO */
