...
.de EM
.br
.\".if !\\n(TB .if t .wh -1p CM \"This line was replaced with
.if !\\n(TB 			\"this one since cut marks aren't needed
.if \\n(TB \{\
\&\c
'	bp
.	NP
...
.if !\\n(LT .nr LT \\n(LLu
.if \\n(FM+\\n(HM>=\\n(.p \{\
.	tm 3 6"HM + FM longer than page"
.	ab
.\}
.\".if t .CM	\"this line is deleted since cut marks aren't needed any more
.if !\\n(HM .nr HM 1i
.po \\n(POu
.nr PF \\n(.f
.nr PX \\n(.s
...
..
.	\" CM - cut mark
'\".de CM \"Taken out since cut marks aren't needed any longer
'\".po 0
'\".lt 7.6i
'\".ft 1
'\".ps 10
...
'\".ps
'\".ft
'\"..	\"Restore to this line if cut marks are later desired
.	\" I - italic font
.de I
.nr PQ \\n(.f
.if t .ft 2
...
..
.co
.if \n(mo=1 .ds MO 3 9"January"
.if \n(mo=2 .ds MO 3 10"February"
.if \n(mo=3 .ds MO 3 11"March"
.if \n(mo=4 .ds MO 3 12"April"
.if \n(mo=5 .ds MO 3 13"May"
.if \n(mo=6 .ds MO 3 14"June"
.if \n(mo=7 .ds MO 3 15"July"
.if \n(mo=8 .ds MO 3 16"August"
.if \n(mo=9 .ds MO 3 17"September"
.if \n(mo=10 .ds MO 3 18"October"
.if \n(mo=11 .ds MO 3 19"November"
.if \n(mo=12 .ds MO 3 20"December"
.\".ie \n(yr>9 .ds DY \*(MO \n(dy, 19\n(yr
.\".el .ds DY \*(MO \n(dy, 190\n(yr
.\" *** INTERNATIONALIZED DATE DEFINITION ***
.ds DY0 0
.nr * 0 1
.IZ
.em EM
