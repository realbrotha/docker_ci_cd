/* @(#)34	1.1.1.3  src/tcpip/usr/include/isode/psap2.h, isodelib7, tcpip530 5/18/00 14:07:25 */
/*
...
struct PSAPstart {		/* P-CONNECT.INDICATION */
    ...
    int     ps_isn;		/* initial serial number */
...
struct PSAPconnect {		/* P-CONNECT.CONFIRMATION */
    ...
    int     pc_isn;		/* initial serial number */
...
struct PSAPactivity {		/* P-ACTIVITY-*.{INDICATION,CONFIRMATION} */
    ...
    int     pv_ssn;		/* RESUME/END Serial number */
