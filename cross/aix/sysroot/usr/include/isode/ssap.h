/* @(#)42	1.1.1.3  src/tcpip/usr/include/isode/ssap.h, isodelib7, tcpip530 5/18/00 14:16:02 */
/*
...
struct SSAPstart {		/* S-CONNECT.INDICATION */
    ...
    int     ss_isn;		/* initial serial number */
...
#define	SC_OFFICIAL(r)	((r) < SC_ADDRESS)
    ...
    int     sc_isn;		/* initial serial number */
...
#define	SV_ENDCNF	0x07	/* S-ACTIVITY-END.CONFIRMATION */
    ...
    int     sv_ssn;		/* RESUME/END Serial number */
