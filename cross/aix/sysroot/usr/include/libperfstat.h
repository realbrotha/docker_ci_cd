...
/*                                                                        */
/* bos53X src/bos/usr/ccs/lib/libperfstat/libperfstat.h 1.4.3.16          */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
/*
 * @(#)91       1.4.3.16     src/bos/usr/ccs/lib/libperfstat/libperfstat.h, libperfstat, bos53X, x2010_31A5 7/19/10 04:16:18
...
#define PERFSTAT_HYPSTATS 0x00000005
#define PERFSTAT_DK_ODM 0x00000006


#define CONFIG_HCALL_STATS     11
#define UNCONFIG_HCALL_STATS   12
...
typedef struct { /* hypervisor data */
        u_longlong_t hyper_purr;
        u_longlong_t ncalls;
        u_longlong_t total_purr;

} perfstat_hyperstat_total_t;
...
extern int perfstat_hyperstat_total(perfstat_id_t *name,
                              perfstat_hyperstat_total_t* userbuff,
                              int sizeof_userbuff,
                              int desired_number);
...
extern int perfstat_partial_reset(char * name,
                                  u_longlong_t defmask);
extern int perfstat_config(uint command, void* arg);

/* the following interfaces operate on WPAR and will return ENOTSUP when called from aix 53 environment*/
