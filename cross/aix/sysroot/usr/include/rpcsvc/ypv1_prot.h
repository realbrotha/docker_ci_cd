/* @(#)47	1.6  src/bos/usr/include/rpcsvc/ypv1_prot.h, libcyp, bos530 6/3/97 10:07:26 */
/* 
...
extern bool _xdr_yprequest(XDR *, struct yprequest *);
extern bool _xdr_ypresponse(XDR *, struct ypresponse *);
...
extern bool _xdr_ypbind_oldsetdom(XDR *, struct ypbind_setdom *);

int v1prot_dofirst(char *, char *, struct dom_binding *,
		   struct timeval, char **, int *, char **, int *);

int v1prot_donext(char *, char *, char *, int, struct dom_binding *,
		  struct timeval, char **, int *, char **, int *);
