...
/*                                                                        */
/* bos53Q src/bos/kernel/sys/dlpi_aix.h 1.5                               */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)88	1.5  src/bos/kernel/sys/dlpi_aix.h, sysxdlpi, bos53Q, q2008_14C3 2/9/08 11:36:38  */
/*
...
typedef struct llctune_s {
	...
	int	k;		/* window size */
	int	r1;             /* read queue low-water-mark */
	int	r2;             /* read queue high-water-mark */
	int     s1;             /* stream head read queue low-water-mark */
        int     s2;             /* stream head read queue high-water-mark */
} llctune_t;
...
#define F_LLC_R1        0x0080
#define F_LLC_R2        0x0100
#define F_LLC_S1        0x0200
#define F_LLC_S2        0x0400
#define F_LLC_ALL       0x07ff
