...
/*                                                                        */
/* bos530 src/bos/kernel/sys/diagex.h 1.12                                */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)02       1.12  src/bos/kernel/sys/diagex.h, sysxdiag, bos530 4/18/02 10:35:26 */
/*
 *
...
#define DGX_DEVICE_DUP	    0x80000021 /* Device has already been diag_open'ed  */
...
typedef struct handl {
   ...
   struct d_handle * dhandle;   /* Used for DMA devices */
   dma_dio  * dio_st;	/* ptr. to DIO struct used in DMA ops. */ 
   uint          timeout;     
   Simple_lock	 intr_lock;	/* lock for int handler sync */
} diag_struc_t;
