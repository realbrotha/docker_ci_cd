...
/*                                                                        */
/* bos530 src/bos/kernel/sys/cdli_fddiuser.h 1.6                          */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)14       1.6  src/bos/kernel/sys/cdli_fddiuser.h, sysxfddi, bos530 4/24/97 19:07:21 */
/*
...
struct	fddi_spec_stats
{
	...
	__ulong32_t	mcast_tx_ok;	/* number of multicast packets 
					 * transmitted
					 */
	__ulong32_t	bcast_tx_ok; 	/* number of broadcast packets
					 * transmitted
					 */
	__ulong32_t	mcast_rx_ok;	/* number of multicast packets 
					 * received
					 */
	__ulong32_t	bcast_rx_ok; 	/* number of broadcast packets
					 * received
					 */
