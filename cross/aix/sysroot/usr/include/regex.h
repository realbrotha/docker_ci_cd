...
/*                                                                        */
/* bos53D src/bos/usr/include/regex.h 1.2.1.14                            */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)21  1.2.1.14  src/bos/usr/include/regex.h, libcpat, bos53D, d2005_21A7 5/20/05 07:31:04 */
...
extern	void	regfree();
#else /* _NO_PROTO */
extern	int 	regcomp(regex_t *__restrict__, const char *__restrict__, int);
extern	int	regexec(const regex_t *__restrict__, const char *__restrict__, size_t, regmatch_t *__restrict__, int);
extern	size_t	regerror(int, const regex_t *__restrict__, char *__restrict__, size_t);
...
extern int		__xregcomp(__xlocale_ptr,regex_t*,const char*,int);
extern size_t		__xregerror(__xlocale_ptr,int,const regex_t*,char*,size_t);
extern int		__xregexec(__xlocale_ptr,const regex_t*,const char*, size_t, regmatch_t*,int);
extern void		__xregfree(__xlocale_ptr,regex_t*);
