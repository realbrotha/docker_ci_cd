...
/*                                                                        */
/* bos530 src/bos/usr/include/im.h 1.2.1.4                                */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)67	1.2.1.2  src/bos/usr/include/im.h, libim, bos420, 9613T 5/26/93 04:59:21 */
/*
...
/* These Functions are prototyped for 64 bit */

IMMap	IMInitializeKeymap(IMLanguage);	/* Do search for Keymap file */
IMMap	IMUseKeymap(char*);		/* Do not search for Keymap file */
void	IMFreeKeymap(IMMap);		/* free resources allocated for IM Keymap */
char	*IMAIXMapping(IMMap, unsigned int , unsigned int , int*);     	/* map keysym to string: do call IMED */
char	*IMSimpleMapping(IMMap, unsigned int , unsigned int , int*);	/* map keysym to string: do not call IMED */
int	IMRebindCode(IMMap, unsigned int , unsigned int ,unsigned char*, int);	/* rebind */
