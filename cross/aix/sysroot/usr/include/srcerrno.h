/* @(#)45       1.12.1.6  src/bos/usr/include/srcerrno.h, cmdsrc, bos530, 0426A_530 6/18/04 17:28:05 */
/*
...
#define SRC_ACTIVE_LIST_ERROR -9130	/* could not create/update SRC
				        ** active_list file on startsrc */
#define SRC_INT_FILE_ERROR -9131	/* could not create/update SRC file
					** during internal processing	*/
#define SRC_KERNEXT_ERROR -9132	/* interface to SRC kernel extension failed */ 
#define SRC_CONFUSAGE -9133 /* usage confsrc */
#define SRC_CONFOK -9134 /* confsrc OK */
#define SRC_AUTHERR -9135 /* user authentication error */
#define SRC_CONNREFUSED -9136 /* couldn't contact via TCP */
#define SRC_SECMETHERR -9137 /* security method error */
#define SRC_UNAME2BIG -9138 /* passed in user name is too long */
#define SRC_UPASS2BIG -9139 /* passed in user passwd is too long */
#define SRC_BADUID -9140 /* UID doesn't exist on local system */
#define SRC_EXTONLY -9141 /* extended request required */

#define SRC_EXTM_EXISTS     -9142 /* External Method already exists */
#define SRC_EXTM_NOTFOUND   -9143 /* External Method not found      */
#define SRC_EXTM_NOSSN      -9144 /* no syssysname specified        */
#define SRC_EXTM_NOACT      -9145 /* no action specified            */
#define SRC_EXTM_NOMETH     -9146 /* no method specified            */
#define SRC_EXTM_SSN2BIG    -9147 /* subsys name too big            */
#define SRC_EXTM_BADACT     -9148 /* invalid action                 */
#define SRC_EXTM_METH2BIG   -9149 /* method pathname too big        */
#define SRC_EXTM_ARG2BIG    -9150 /* method arguments too big       */
#define SRC_EXTM_USR2BIG    -9151 /* user name too large            */

#define SRC_EXTM_BADOPT      -9152 /* bad option specified           */

#define SRC_ADDEXTM_USAGE    -9153 /* add method usage message       */

#define SRC_CHEXTM_USAGE     -9154 /* change object usage            */

#define SRC_RMEXTM_USAGE     -9155 /* remove object usage            */

/* New definitions for long user/group/path/name */
#define SRC_LNOTENAME2BIG -9156  /* notify name to long */
#define SRC_LSUBTYP2BIG   -9157  /* sub_type to long */
#define SRC_LSUBSYS2BIG   -9158  /* subsystem to long */
#define SRC_LSYN2BIG      -9159  /* synonym name to long */
#define SRC_LCMDARG2BIG   -9160  /* command args to long */
#define SRC_LPATH2BIG     -9161  /* subsys path to long */
#define SRC_LSTDIN2BIG    -9162  /* stdin path to long */
#define SRC_LSTDOUT2BIG   -9163  /* stdout path to long */
#define SRC_LSTDERR2BIG   -9164  /* stderr path to long */
#define SRC_LGRPNAM2BIG   -9165  /* group name to long */
#define SRC_LHOST2BIG     -9166  /* host name to long */
#define SRC_LUNAME2BIG    -9167  /* passed in user name is too long */
#define SRC_LUPASS2BIG    -9168  /* passed in user passwd is too long */
#define SRC_LEXTM_SSN2BIG -9169  /* subsys name too big            */
#define SRC_LEXTM_METH2BIG -9170 /* method pathname too big        */
#define SRC_LEXTM_USR2BIG  -9171 /* user name too large            */

#define FIRST_SRC_ERROR SRC_DMNA 
#define LAST_SRC_ERROR SRC_LEXTM_USR2BIG
