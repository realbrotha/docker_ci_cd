...
/*                                                                        */
/* bos530 src/bos/kernext/inet/if_802_5.h 1.15.1.14                       */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)46	1.15.1.14  src/bos/kernext/inet/if_802_5.h, sockinc, bos530 11/9/00 11:49:23 */
/*
...
#define	RCF_SINGLEROUTE_BROADCAST 0xC000/* all routes broadcast		*/
...
#define	route_bytes(mac)	((ntohs((mac)->mac_rcf) >> 8) & 0x1f)
#define	has_route(mac)		((mac)->mac_src_802_5[0] & RI_PRESENT)
#define	largest_frame(mac)	(ntohs((mac)->mac_rcf) & RCF_FRAME_MASK)
...
#define IE5_FILLIN_HDR_IPV6(macp, srcp, destp, Rcf, segp) { \
	...
	*(struct char6 *)(macp)->mac_src_802_5 =	\
	...
	if ((Rcf)) {	\
		...
		else bzero((macp)->mac_seg, mac_size((macp)));	\
	} else	\
		(macp)->mac_src_802_5[0] &= ~RI_PRESENT;	\
	ie2_llc((caddr_t)((macp))+mac_size((macp)), htons(ETHERTYPE_IPV6));\
}
...
#define IE5_FILLIN_HDR(macp, srcp, destp, Rcf, segp) { \
	...
	*(struct char6 *)(macp)->mac_src_802_5 =	\
	...
	if ((Rcf)) {	\
		...
		(macp)->mac_src_802_5[0] &= ~RI_PRESENT;	\
	ie2_llc((caddr_t)((macp))+mac_size((macp)), htons(_802_5_TYPE_IP));	\
}
#endif
