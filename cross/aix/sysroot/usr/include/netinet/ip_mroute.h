...
/*                                                                        */
/* bos530 src/bos/kernext/inet/ip_mroute.h 1.6                            */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/* @(#)22	1.6  src/bos/kernext/inet/ip_mroute.h, sysxinet, bos530 2/4/03 14:19:16 */
/*
...
struct sioc_vif_req {
    ...
    __ulong32_t icount;		/* Input packet count on vif		*/
    __ulong32_t ocount;		/* Output packet count on vif		*/
    __ulong32_t ibytes;		/* Input byte count on vif		*/
    __ulong32_t obytes;		/* Output byte count on vif		*/
};
...
#ifdef _KERNEL
extern	simple_lock_data_t	ip_mrouter_lock;
#define	IP_MROUTE_LOCKINIT()	{	\
      lock_alloc(&ip_mrouter_lock, LOCK_ALLOC_PIN, IP_MROUTE_LOCK_FAM, -1); \
      simple_lock_init(&ip_mrouter_lock);	\
}
#define IP_MROUTE_LOCK_DECL() int _ipmrl_spl;
#define IP_MROUTE_LOCK() _ipmrl_spl = disable_lock(PL_IMP, &ip_mrouter_lock)
#define IP_MROUTE_UNLOCK() unlock_enable(_ipmrl_spl, &ip_mrouter_lock)
#endif /* KERNEL */
