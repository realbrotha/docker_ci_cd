...
extern int	vswscanf(const wchar_t * __restrict__, const wchar_t * __restrict__, va_list);
...
extern int vswprintf(wchar_t * __restrict__, size_t, const wchar_t * __restrict__, va_list);
#else
...
extern int vswprintf(wchar_t * __restrict__, size_t, const wchar_t * __restrict__, __va_list);
#endif /* _VA_LIST */
#ifdef __cplusplus98__interface__
