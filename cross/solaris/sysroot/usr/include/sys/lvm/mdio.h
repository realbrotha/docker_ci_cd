...
#pragma ident	"@(#)mdio.h	2.17	04/11/17 SMI"
...
#define	MD_MN_GET_SM_STATE	(MDIOC|97) /* Get the submirror state MN only */
...
/*
 * Ioctl structure for MD_MN_GET_SM_STATE
 */
typedef struct md_mn_get_sm_state {
	MD_DRIVER
	minor_t		mnum;		/* Unit to obtain submirror info from */
} md_mn_get_sm_state_t;
...
#define	MD_SET_MN_SM_STATE_RC	0x00200000  /* Submirror state gotten for set */
...
#define	MD_SET_STAT_BITS "\020\001HALTED\002SNARFED\003SNARFING\004STALE" \
			    ...
			    "\015CLRTAG\016KEEPTAG\017PUSHLB\018MNSET" \
			    "\019DIDCLUP"
