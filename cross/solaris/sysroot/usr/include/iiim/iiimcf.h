...
enum IIIMCF_EVENT_TYPES {
	...
	IIIMCF_EVENT_TYPE_HOTKEY_NOTIFY = 0x4000,
...
/* Hotkeys */
typedef struct IIIMCF_hotkey IIIMCF_hotkey;
...
/* Hotkey Profile */
typedef struct IIIMCF_hotkey_profile IIIMCF_hotkey_profile;
...
/* Namespace Listener*/
typedef struct IIIMCF_ns_listener IIIMCF_ns_listener;
...
/* Namespace */
typedef struct IIIMCF_ns IIIMCF_ns;
struct IIIMCF_ns {
    int ns_id;
    int nsc_fd;
    char *filename;
...
/* IM_SETICVALUES */
extern IIIMF_status iiimcf_context_set_attr(
    IIIMCF_context context,
    IIIMCF_attr attr
);
...
extern IIIMF_status iiimcf_get_im_id(
    IIIMCF_handle handle,
    int *pim_id
);
...
extern IIIMF_status iiimcf_get_ic_id(
    IIIMCF_context context,
    int *pic_id
);
...
extern IIIMF_status iiimcf_create_hotkey_notify_event(
    IIIMCF_event *pevent
);
...
extern IIIMF_status iiimcf_create_aux_getvalues_event(
    const IIIMP_card16 *aux_name,
    IIIMP_card32 class_idx,
    int num_intvals,
    const IIIMP_card32 *pintvals,
...
extern IIIMF_status iiimcf_is_capability_supported(
    IIIMCF_handle handle,
    int capability
);
