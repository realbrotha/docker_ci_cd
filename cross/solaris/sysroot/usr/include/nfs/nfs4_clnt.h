...
#pragma ident	"@(#)nfs4_clnt.h	1.44	05/08/09 SMI"
 ...
 *
 * 'oo_bad_seqid' tells whether this open owner used a bad seqid (that is,
 * got NFS4ERR_BAD_SEQID).  With this set, this open owner will no longer be
 * used for future OTW calls.
 *
 ...
 *	information.
 *
 *	The mi_clientid_lock mutex protects the following fields:
 *		mi_clientid_next
 *		mi_clientid_prev
 *		mi_clientid
 *		mi_open_files
 ...
 *	  nfs_rtable4_lock > mi_clientid_lock > mi_lock
...
typedef struct mntinfo4 {
	 ...
	 * Lease Management
	 */
	kmutex_t	mi_clientid_lock; /* lock to protect clientid list */
 ...
 *
 * Lock order:
 * nfs4_server::s_lock > mntinfo4::mi_clientid_lock
...
extern int	nfs4lookup_setup(char *, lookup4_param_t *);
 ...
 *
 * 'os_bad_seqid' tells whether this open stream's open owner used a
 * bad seqid (that is, got NFS4ERR_BAD_SEQID).  With this set, this open
 * stream will no longer be used for future OTW calls.
 *
 * Lock ordering:
 ...
 *	os_node
 *
 * 'os_open_owner' is set at creation time, and
...
extern void		unlock_nfs4_server(nfs4_server_t *);
...
extern int	nfs4setclientid(struct mntinfo4 *, struct cred *, bool_t);
...
extern nfs4_bseqid_entry_t *nfs4_create_bseqid_entry(nfs4_open_owner_t *,
		    nfs4_open_stream_t *, nfs4_lock_owner_t *, vnode_t *,
		    pid_t, nfs4_tag_type_t, seqid4);
...
extern void	nfs4_queue_fact(nfs4_fact_type_t, mntinfo4_t *, nfsstat4,
		    nfs4_recov_t, nfs_opnum4, bool_t, char *);
