...
#define MASK_USER_MODE (1 << 12)
#define MASK_V8PLUS (1 << 13)
#define MASK_VIS (1 << 14)
#define MASK_VIS2 (1 << 15)
#define MASK_VIS3 (1 << 16)
#define MASK_DEPRECATED_V8_INSNS (1 << 17)
#define MASK_LEON (1 << 18)
#define MASK_LEON3 (1 << 19)
#define MASK_LONG_DOUBLE_128 (1 << 20)
#define MASK_SPARCLET (1 << 21)
#define MASK_SPARCLITE (1 << 22)
#define MASK_V8 (1 << 23)
#define MASK_V9 (1 << 24)
...
#define TARGET_USER_MODE ((target_flags & MASK_USER_MODE) != 0)
...
enum opt_code
{
  ...
  OPT_m32 = 1041,                            /* -m32 */
  OPT_m64 = 1042,                            /* -m64 */
  OPT_mapp_regs = 1043,                      /* -mapp-regs */
  OPT_mcbcond = 1044,                        /* -mcbcond */
  OPT_mcmodel_ = 1045,                       /* -mcmodel= */
  OPT_mcpu_ = 1046,                          /* -mcpu= */
  OPT_mdebug_ = 1047,                        /* -mdebug= */
  OPT_mfaster_structs = 1048,                /* -mfaster-structs */
  OPT_mfix_at697f = 1049,                    /* -mfix-at697f */
  OPT_mfix_ut699 = 1050,                     /* -mfix-ut699 */
  OPT_mflat = 1051,                          /* -mflat */
  OPT_mfmaf = 1052,                          /* -mfmaf */
  OPT_mfpu = 1053,                           /* -mfpu */
  OPT_mhard_float = 1054,                    /* -mhard-float */
  OPT_mhard_quad_float = 1055,               /* -mhard-quad-float */
  OPT_mimpure_text = 1056,                   /* -mimpure-text */
  OPT_mmemory_model_ = 1057,                 /* -mmemory-model= */
  OPT_mpopc = 1058,                          /* -mpopc */
  OPT_mptr32 = 1059,                         /* -mptr32 */
  OPT_mptr64 = 1060,                         /* -mptr64 */
  OPT_mrelax = 1061,                         /* -mrelax */
  OPT_msoft_float = 1062,                    /* -msoft-float */
  OPT_msoft_quad_float = 1063,               /* -msoft-quad-float */
  OPT_mstack_bias = 1064,                    /* -mstack-bias */
  OPT_mstd_struct_return = 1065,             /* -mstd-struct-return */
  OPT_mtune_ = 1066,                         /* -mtune= */
  OPT_munaligned_doubles = 1067,             /* -munaligned-doubles */
  OPT_muser_mode = 1068,                     /* -muser-mode */
  OPT_mv8plus = 1069,                        /* -mv8plus */
  OPT_mvis = 1070,                           /* -mvis */
  OPT_mvis2 = 1071,                          /* -mvis2 */
  OPT_mvis3 = 1072,                          /* -mvis3 */
  OPT_n = 1073,                              /* -n */
  ...
  OPT_pthread = 1101,                        /* -pthread */
  OPT_pthreads = 1102,                       /* -pthreads */
  OPT_quiet = 1103,                          /* -quiet */
  OPT_r = 1104,                              /* -r */
  OPT_rdynamic = 1105,                       /* -rdynamic */
